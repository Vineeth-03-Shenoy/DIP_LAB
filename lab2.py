...
# Load the image
image = cv2.imread(r'C:\Users\vinee\Desktop\3rd_YEAR\DIP\DigImgProc\NOODLES.webp')
...
image_transformed = cv2.warpAffine(image_rotated, M_translate, (img.shape[1], img.shape[0]))
